...
# Los numeros se deben introducir uno por uno, es decir despes de escribir el primer numero, damos 'enter'
#    luego escribimos el segundo numero y volvemos a dar enter continuar.
.data
