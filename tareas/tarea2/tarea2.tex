...
\item Un programa tarda 9 millones de ciclos en una computadora cuyo ciclo dura 3 ns. ¿Cuál es el tiempo de CPU?
  ...
  \begin{center}
    \(\therefore\) \text{Un programa tarda 9 millones de ciclos en una computadora cuyo ciclo dura 3 ns.}\\
    \text{Su tiempo de CPU es de 27 milisegundos.}
  \end{center}
  \bigskip
...
\item Un programa tarda 14 millones de ciclos en una máquina a 2.4 GHz. ¿Cuál es el tiempo de CPU?
  ...
  \begin{center}
    \(\therefore\) \text{Un programa tarda 14 millones de ciclos en una máquina a 2.4 GHz.}\\
    \text{Su tiempo de CPU es de 5.83 milisegundos.}
  \end{center}
  \bigskip
